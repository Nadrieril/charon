...
#[visitable_group(
    ...
    override(
        ...
        DeBruijnId, Ty, TyKind, Region, TraitRef, PolyTraitRef, TraitRefContents, TraitRefKind,
...
#[visitable_group(
    ...
    skip(
        ...
        TraitRef, PolyTraitRef, ScalarTy, Region, RegionId, (), String, PathBuf, bool, u32, usize,
