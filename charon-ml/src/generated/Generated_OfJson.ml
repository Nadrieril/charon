...
and region_args_of_json (ctx : of_json_ctx) (js : json) :
...
and trait_ref_kind_of_json (ctx : of_json_ctx) (js : json) :
  ...
  combine_error_msgs js __FUNCTION__
    ...
    | `Assoc [ ("TraitImpl", _0) ] ->
        ...
        Ok (TraitImpl _0)
    | `Assoc [ ("Clause", `List [ _0; _1 ]) ] ->
        let* _0 = de_bruijn_var_of_json trait_clause_id_of_json ctx _0 in
        let* _1 = region_args_of_json ctx _1 in
        Ok (Clause (_0, _1))
    | `Assoc [ ("ParentClause", `List [ _0; _1; _2 ]) ] ->
        let* _0 = trait_ref_of_json ctx _0 in
        let* _1 = trait_clause_id_of_json ctx _1 in
        let* _2 = region_args_of_json ctx _2 in
    ...
    | `Assoc
        ...
        let* clause_id = trait_clause_id_of_json ctx clause_id in
        let* clause_args = region_args_of_json ctx clause_args in
